...
import { FaFileAudio, FaFileVideo } from 'react-icons/fa'; // Import icons for audio and video
...
const ProfilePage = () => {
  ...
  // Define nav items for the main navbar
  const navItems = [
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen text-white bg-neutral-900">
      ...
      {/* Container for profile content below the navbar */}
